...
public class b2_Const2 extends b1_BaapConstructor{
...

	{
		...
		//before every construcor calling. it does not mean.. in case of constricutor chaining .. where we are running 4 constructors in chain.. will result in 4 init..here only 1 init will be called
		//but here we are saying.. for each type of diff constructor call.. we have init block run..
